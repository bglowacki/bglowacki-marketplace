...
description: Collects Claude Code session history and Prometheus metrics for analysis. Triggers on "collect usage", "gather usage data", "usage data", or "collect sessions".
allowed-tools: Bash
---
