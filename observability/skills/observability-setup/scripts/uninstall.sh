...
echo ""
echo "=== Step 2: Delete NodePort service ==="
kubectl delete svc otel-collector-external -n observability --ignore-not-found=true
...
echo ""
echo "=== Step 8: Verify teardown ==="
kubectl get namespace observability 2>/dev/null && echo "⚠ Namespace still terminating..." || echo "✓ Namespace deleted"
