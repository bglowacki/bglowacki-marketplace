...
description: Deploy OTEL observability stack to Kubernetes. Triggers on "setup observability", "install observability", "configure metrics", "/setup-observability".
---
...
Run this skill: `/setup-observability`
